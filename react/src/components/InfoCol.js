  ...
  return(
    <div>
      ...
      <p>Have you ever said "Of course I'm getting sick. This always happens to me."
        ...
        only one! People all around the world get cold symptoms all the time. With
        Flu Are Not Alone, you can see that there ARE others out there feeling the
        same way. Flu Are Not Alone.
      </p>
